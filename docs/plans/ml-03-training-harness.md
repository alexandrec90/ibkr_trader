...
[CLAUDE.md](../../CLAUDE.md) · [signals/features.py](../../src/ibkr_trader/signals/features.py)
(ML-02's builder) · [signals/eligibility.py](../../src/ibkr_trader/signals/eligibility.py) ·
